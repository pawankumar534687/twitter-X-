...
const Home = () => {
  return (
    <div className="flex flex-col md:flex-row bg-black text-white font-bold ml-80 max-md:ml-24 h-[2000px]">
      ...
      <div className="flex flex-col w-full bg-black max-md:w-80 md:w-[600px] border-l border-gray-600 border-r h-[12000px]">
        ...
        <div className="border-b border-gray-600 h-32 flex  max-md:h-16">
          
          <div className="text-lg text-zinc-500 p-4 ">
          What's  Happening?!
          </div>
          <button className="bg-zinc-500 rounded-full hover:bg-zinc-700 mt-20 ml-72 max-md:mt-0 max-md:ml-0 justify-end items-end text-lg w-16 h-10">Post</button>
         
        </div>
        <div className="flex items-center justify-center  text-2xl text-yellow-500">This is Home Page</div>
